...
class CreateDataset:
  def __init__(
      self,
      filepath,
      columns_required:list=["label", "string"],
      tag2idx:dict={'0': 0,'1': 1, '2':2}
    ):
    # Tag to index
